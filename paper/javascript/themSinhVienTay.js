...
//async function main(mssv, hoten, cmnd, dinhdanh){
exports.themSV =  async function(mssv, hoten, cmnd, dinhdanh) {
    try {
        ...
        await contract.submitTransaction('themSinhVien', mssv , hoten, cmnd);
